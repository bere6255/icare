    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/s_transec_hys" aria-expanded="false"><i class="fas fa-notes-medical"></i><span class="hide-menu">Transections</span></a></li>
